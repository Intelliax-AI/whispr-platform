...
import { getModelsForProvider } from "@/config/models.constants";
      ...
      <div className="space-y-4 mt-2">
        {sttVariables
          ...
          .map((variable) => {
            ...
            // Check if this is a model variable and provider has predefined models
            const isModelVariable = variable.key === "model";
            const availableModels = isModelVariable
              ? getModelsForProvider(selectedSttProvider?.provider || "", "stt")
              : [];
            ...
            return (
              <div className="space-y-1" key={variable?.key}>
                <Header
                  ...
                  description={`${hasModels ? "Select" : "Add"} your preferred ${variable?.key?.replace(
                    /_/g,
                    " "
                  )} for ${
                    allSttProviders?.find(
